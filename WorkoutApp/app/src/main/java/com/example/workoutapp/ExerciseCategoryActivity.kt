...
class ExerciseCategoryActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val exerciseList = when (categoryName) {
            "Yoga" -> listOf(
            ...
            "Burning fat" -> listOf(
                Exercise("Abs Workout", "1. Crunches – 3 sets of 15 reps\n" +
                        ...
                        "5. Bicycle Crunches – 3 sets of 20 reps (10 each side)\n" +
                        "6. Hanging Knee Raises – 3 sets of 12 reps (optional)", R.drawable.abs, ""),
                Exercise("Running", "1. Warm-Up – Walk or jog lightly for 5–10 minutes.\n" +
                        "2. Posture – Keep your back straight, arms relaxed, and land midfoot.\n" +
                        "3. Breathing – Breathe deeply and rhythmically through your nose and mouth.\n" +
                        "4. Pace – Start slow, gradually increase speed based on endurance.\n" +
                        "5. Duration – Run for 20–60 minutes, depending on fitness level.\n" +
                        "6. Cool-Down – Walk for 5 minutes, then stretch.", R.drawable.running, ""),
                Exercise("Treadmill", "1. Warm-Up – Walk at 3–4 km/h for 5 minutes.\n" +
                        "2. Steady-State Cardio – Jog or run at a comfortable pace for 20–40 minutes.\n" +
                        "3. Interval Training (HIIT) –\n" +
                        "4. Sprint 30 sec, walk 60 sec (repeat 8–12 times).\n" +
        ...
        val adapter = ExerciseAdapter(exerciseList) { selectedExercise ->
            val intent = Intent(this, ExerciseDetailActivity::class.java)
            intent.putExtra("EXERCISE_NAME", selectedExercise.name)
            intent.putExtra("EXERCISE_DESCRIPTION", selectedExercise.description)
            intent.putExtra("EXERCISE_REPS", selectedExercise.reps)
            intent.putExtra("EXERCISE_IMAGE", selectedExercise.imageResId)
